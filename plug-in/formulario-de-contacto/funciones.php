<?php
  // Esta función sirve para permitir a un visitante que envíe un email a la organización, desde su web oficial.
  ...
  $emailDestino = "admin@olivaires.com.ar";
  ...
  $mail->Subject = "Email del visitante ".$emailContacto."."; // Este es el titulo del email.
